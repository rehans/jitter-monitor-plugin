...
#define stringPluginName "JitterMonitor"
...
DEF_CLASS2(
    INLINE_UID_FROM_FUID(jitter_monitoring::kProcessorUID),
    ...
    JitterMonitorVST3Category,  // Subcategory for this Plug-in (to be changed)
    FULL_VERSION_STR,           // Plug-in version (to be changed)
    kVstVersionString, // the VST 3 SDK version (do not changed this, use always
                       // this define)
    jitter_monitoring::Processor::createInstance) // function pointer called
                                                  // when this component should
                                                  // be instantiated

// its kVstComponentControllerClass component
DEF_CLASS2(
    INLINE_UID_FROM_FUID(jitter_monitoring::kControllerUID),
    PClassInfo::kManyInstances,   // cardinality
    ...
    kVstVersionString, // the VST 3 SDK version (do not changed this, use always
                       // this define)
    jitter_monitoring::Controller::createInstance) // function pointer called
                                                   // when this component should
                                                   // be instantiated
